...
public class TestSchemaConverter {
  ...
  private final Schema complexArrowSchema =
      new Schema(
          asList(
              ...
              field(
                  ...
                  field(null, new ArrowType.Date(DateUnit.DAY))),
  ...
  private final MessageType complexParquetSchema =
      Types.buildMessage()
  ...
  private final Schema allTypesArrowSchema =
      new Schema(
          asList(
              ...
              field(
                  "e",
                  new ArrowType.Union(UnionMode.Sparse, new int[] {1, 2, 3}),
  ...
  private final MessageType allTypesParquetSchema =
      Types.buildMessage()
          ...
          .addField(Types.optionalGroup().addField(Types.optional(BINARY).named("ba")).named("b"))
          .addField(
              Types.optionalList()
          ...
          .addField(
              Types.optionalList()
                  .setElementType(Types.optional(BINARY).named("element"))
                  .named("d"))
          .addField(Types.optionalGroup().addField(Types.optional(BINARY).named("ea")).named("e"))
  ...
  private final Schema supportedTypesArrowSchema =
      new Schema(
          asList(
              ...
              field(
                  "l", new ArrowType.Time(org.apache.arrow.vector.types.TimeUnit.MILLISECOND, 32)),
              field(
                  "m",
                  new ArrowType.Timestamp(
                      org.apache.arrow.vector.types.TimeUnit.MILLISECOND, "UTC"))));

  private final MessageType supportedTypesParquetSchema =
      Types.buildMessage()
          .addField(Types.optionalGroup().addField(Types.optional(BINARY).named("ba")).named("b"))
          .addField(
              Types.optionalList()
  ...
  private final Schema paperArrowSchema =
      new Schema(
          asList(
              ...
              field(
                  ...
                  field(
                      ...
                      false,
                      new ArrowType.List(),
                      field(null, false, new ArrowType.Int(64, true))),
                  field(
                      "Forward",
                      false,
                      new ArrowType.List(),
  ...
  public void testAllMap() throws IOException {
    ...
    Assert.assertEquals(
        "p, s<p>, l<p>, l<p>, u<p>, p, p, p, p, p, p, p, p, p, p, p, p, p, p, p, p, p, p, p, p, p",
        toSummaryString(map));
  }
